...
class Detailminta extends StatefulWidget {
  List list;
  int index;
  Detailminta({this.index,this.list});
  @override
  _DetailmintaState createState() => _DetailmintaState();
}

class _DetailmintaState extends State<Detailminta> {
  void deleteminta(){
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(10.0, 7.0, 5.0, 10.0),
                          child: Text("Keterangan: ${widget.list[widget.index]['keterangan']}", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                        ),
                      ],
                    ),
                  ),
